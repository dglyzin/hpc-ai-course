     ...
     \section{1.3. Prompt Engineering - системный подход}
    {
        ...
        \begin{frame}{ЗАПРОСЫ}
            ...
            \begin{itemize}
                ...
                \item [-] Две разных задачи: создание системного промпта для многократного применения (возможно, разными людьми), когда затраты на его создание пренебрежимо малы, и
        ...
        \begin{frame}{ЧЕК-ЛИСТ ДЛЯ ПРОВЕРКИ ПРОМПТА}
