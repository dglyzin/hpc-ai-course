...
\end{frame}	
    ...
    \begin{frame}{API AI API AI API}
    	\begin{itemize}
    		...
    		\item [-] OpenAI API --- это API, первоначально созданный OpenAI для программирования запросов к ChatGPT, но впоследствии ставший стандартом для всех серверов LLM (в частности, для ollama.cpp, которую мы используем)
    	\end{itemize}
    \end{frame}
