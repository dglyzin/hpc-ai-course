...
\begin{tikzpicture}[
  ...
  bend angle=45,
  auto]
\node[draw,rectangle,minimum height = 8 cm,text centered ] (Inliniband) at (0,0) {\rotatebox[origin=c]{-90}{56 Gb/s Inliniband}};
\node[draw,rectangle,right of=Inliniband,xshift=2cm, yshift=3.6cm] (dnode09) {dnode09};
\node[draw,rectangle,below of=dnode09, yshift=0.4cm] (dnode10) {dnode10};
\node[draw,rectangle,below of=dnode10, yshift=0.4cm] (dnode11) {dnode11};
\node[draw,rectangle,below of=dnode11, yshift=0.4cm] (dnode12) {dnode12};
\node[draw,rectangle,below of=dnode12, yshift=0.4cm] (dnode13) {dnode13};
\node[draw,rectangle,below of=dnode13, yshift=0.4cm] (dnode14) {dnode14};
\node[draw,rectangle,below of=dnode14,minimum width = 1.8 cm, yshift=-0.6cm] (dnode07) {\rotatebox[origin=c]{-90}{dnode07}};
\node[draw,rectangle,below of=dnode07,minimum width = 1.8 cm, yshift=-1cm] (dnode08) {\rotatebox[origin=c]{-90}{dnode08}};
\node[draw,rectangle,right of=dnode08,xshift=2cm] (USER) {USER};
