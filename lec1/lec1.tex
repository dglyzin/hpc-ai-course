...
\begin{tikzpicture}[
  ...
  bend angle=45,
  auto]
\node[draw,rectangle,minimum width = 10 cm,text centered ] (Inliniband) at (0,0) {56 Gb/s Inliniband};
...
\node[draw,rectangle,left of=dnode14,minimum height = 1.8 cm,minimum width = 1.8 cm,xshift=-0.4cm] (dnode07) {dnode07};
\node[draw,rectangle,left of=dnode07,minimum height = 1.8 cm,minimum width = 1.8 cm,xshift=-1cm] (dnode08) {dnode08};
\node[draw,rectangle,below of=dnode08,minimum height = 1.8 cm,minimum width = 1.8 cm,yshift=-2cm] (USER) {USER};
%\draw[->] (Inliniband) |- (dnode09);
%\path[->] (Inliniband) edge (dnode09);
\end{tikzpicture}
\end{frame}
